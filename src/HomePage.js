    ...
    <>
      <div className="relative flex justify-center items-center max-w-screen min-h-screen overflow-hidden">
        ...
        <h1 className='text-white flex flex-col justify-center items-center mx-4 gap-0  md:gap-2 xl:gap-3 text-center'>
          ...
          <button class="btn  mt-6 gap-6 w-fit text-sm sm:text-base md:text-lg lg:text-xl hover:text-black ">  <a href="https://docs.google.com/forms/d/e/1FAIpQLSdSXaf0hRNj5VSnAydFDtiCegmmo00L0LYzm3ceDqMBFyc6QA/viewform" target="_blank">REGISTER</a>
       
</button>
<button class="btn w-fit sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl hover:text-black "> VIEW PROBLEM STATEMENT
</button>
          </div>
...
<p className='neon-text-red'> View Problem Statement</p>
  ...
  <div id="accordion-collapse" data-accordion="collapse" className='mx-16 md:mx-24 lg:mx-48 xl:mx-96 bg-back-blue bg-opacity-80'>
    ...
    <button class="btn mt-3 w-fit text-sm sm:text-base md:text-lg lg:text-xl hover:text-black">Bhargav - 9043444670
        ...
        <section className='flex  justify-center md:text-lg items-center mb-20'><div className='flex  mt-6 flex-col sm:flex-row justify-center items-center  gap-6'>
          <button class="btn  w-fit text-sm sm:text-base md:text-lg lg:text-xl hover:text-black "> <a href="https://docs.google.com/forms/d/e/1FAIpQLSdSXaf0hRNj5VSnAydFDtiCegmmo00L0LYzm3ceDqMBFyc6QA/viewform" target="_blank">REGISTER</a>
       
</button>
<button class="btn w-fit text-sm sm:text-base md:text-lg lg:text-xl hover:text-black "> VIEW PROBLEM STATEMENT
</button>
          </div></section>
    </>
  );
